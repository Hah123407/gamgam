...
GB_Aimbot:AddLabel('in order for the')
GB_Aimbot:AddLabel('aimbot to work YOU have to use the keybind, not the toggle') 
...
function Visuals(Player)
	...
	Debug_CheatName.Text = "Amalgam" -- awp is weird..
		do -- Debug Ping
